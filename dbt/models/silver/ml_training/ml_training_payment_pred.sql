...
select 
    ...
    -- F. Features từ ftr_macroeconomic (DISABLED - World Bank data not available)
...
left join customers c
    on cast(i.cust_number as varchar) = cast(c.customer_code as varchar) -- Giả định 2 key này khớp nhau
