import { Bell, Menu, X, Download, Filter, Calendar as CalendarIcon, TrendingUp, CreditCard, Users, CheckCircle, DollarSign, Activity, Clock, AlertCircle, ArrowUpRight, ArrowDownRight, FileText, FileSpreadsheet } from 'lucide-react';
...
export function Reports() {
  ...
  /**
   * Handle report download - Export trực tiếp từ client (nhanh, không cần đợi backend)
   */
