...
import { useDashboardSummary, usePaymentSuccessRate, useAlerts } from '../lib/api/hooks';
...
export function Dashboard() {
  ...
  const metrics = summary ? [
    ...
    },
    {
      ...
      value: `${Math.round(summary.total_revenue / 1000000)}`,
      unit: 'triệu ₫',
      change: '+12%',
    ...
    },
    {
      ...
      value: `${Math.round(summary.total_receivables / 1000000)}`,
      unit: 'triệu ₫',
      change: `${summary.overdue_invoices_count} quá hạn`,
          ...
          <div className="lg:col-span-2 space-y-6">
            <Card className="border-0 shadow-sm bg-gradient-to-br from-white to-blue-50/30">
              <CardHeader className="pb-3">
                <CardTitle className="text-slate-900 font-alata" style={{ fontSize: '20px', fontWeight: 400 }}>
                  Doanh thu 14 ngày
                </CardTitle>
                <CardDescription className="font-darker-grotesque" style={{ fontSize: '16px' }}>
                  Theo dõi xu hướng doanh thu và các điểm bất thường
                </CardDescription>
              </CardHeader>
              <CardContent>
                <RevenueChart />
            ...
            <Card className="border-0 shadow-sm bg-gradient-to-br from-white to-green-50/30">
              <CardHeader className="pb-3">
                ...
                <CardDescription className="font-darker-grotesque" style={{ fontSize: '16px' }}>
                  Dự đoán doanh thu dựa trên AI và dữ liệu lịch sử
                </CardDescription>
              </CardHeader>
              <CardContent>
                <ForecastChart />
