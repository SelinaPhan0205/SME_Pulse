...
WITH (
    format = 'PARQUET',
    external_location = 's3a://sme-pulse/bronze/raw/world_bank/indicators/'
);
...
WITH (
    format = 'PARQUET',
    external_location = 's3a://sme-pulse/bronze/raw/vietnam_provinces/provinces/'
);
...
WITH (
    format = 'PARQUET',
    external_location = 's3a://sme-pulse/bronze/raw/vietnam_provinces/districts/'
);
