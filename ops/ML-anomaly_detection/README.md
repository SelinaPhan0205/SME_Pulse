...
**Chức năng:**
- Load dữ liệu từ `"sme_pulse".gold.fact_bank_txn` (206,914 giao dịch)
...
- Save alerts vào `"sme_pulse".gold.ml_anomaly_alerts`
- Save statistics vào `"sme_pulse".gold.ml_anomaly_statistics`
...
### 📌 Table 1: `"sme_pulse".gold.ml_anomaly_alerts` (Chi tiết - DETAIL)
...
### 📊 Table 2: `"sme_pulse".gold.ml_anomaly_statistics` (Tổng quát - SUMMARY)
...
│      ├─ Insert: "sme_pulse".gold.ml_anomaly_alerts
│      │   └─ 537 alert rows                   │
│      ├─ Insert: "sme_pulse".gold.ml_anomaly_statistics
